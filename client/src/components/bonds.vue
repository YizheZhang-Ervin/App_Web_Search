<template>
  <main class="bonds" style="overflow-y: hidden">
    <div class="left">
      <div id="charts" style="width:45vw;height:70vh;"></div>
    </div>
    <div class="right" style="height:100vh">
      ...
      <div class="right-parameters">
        ...
        <form id="form001">
          ...
          <br />
          <label id="tau1label" for="tau1" style="display: none"
            >τ1 (tau1)</label
          >
          ...
          <br />
          <label id="beta3label" for="beta3" style="display: none"
            >β3 (beta3)</label
          >
          <input
            id="beta3"
          ...
          (response) => {
            if (response.data.error == "error") {
              ...
              document.getElementById("ds").style.background =
                "rgba(255,0,0,0.5)";
              document.getElementById("rowNo").style.background =
                "rgba(255,0,0,0.5)";
            } else {
...
html,body,#app,main,.scroll,.left,.right{
    width:100%;
}
</style>